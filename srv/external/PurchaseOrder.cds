/* checksum : 792429fc35658a5661ea7fd72d9226eb */
@cds.external : true
...
entity PurchaseOrder.A_POSubcontractingComponent {
...
entity PurchaseOrder.A_PurchaseOrder {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchase Order'
  ...
  to_PurchaseOrderItem : Composition of many PurchaseOrder.A_PurchaseOrderItem {  };
  to_PurchaseOrderNote : Composition of many PurchaseOrder.A_PurchaseOrderNote {  };
} actions {
  function GetOutputBinaryData() returns PurchaseOrder.GetPDFResult;
  function GetPDF() returns PurchaseOrder.GetPDFResult;
};
...
@sap.content.version : '1'
@sap.label : 'Item'
entity PurchaseOrder.A_PurchaseOrderItem {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchase Order'
  @sap.quickinfo : 'Purchase Order Number'
  key PurchaseOrder : String(10) not null;
  ...
  to_PurchaseOrder : Association to PurchaseOrder.A_PurchaseOrder {  };
  to_AccountAssignment : Composition of many PurchaseOrder.A_PurOrdAccountAssignment {  };
  to_PurchaseOrderItemNote : Composition of many PurchaseOrder.A_PurchaseOrderItemNote {  };
  to_PurchaseOrderPricingElement : Composition of many PurchaseOrder.A_PurOrdPricingElement {  };
  to_ScheduleLine : Composition of many PurchaseOrder.A_PurchaseOrderScheduleLine {  };
};
...
entity PurchaseOrder.A_PurchaseOrderItemNote {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
...
entity PurchaseOrder.A_PurchaseOrderNote {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchase Order'
  @sap.quickinfo : 'Purchase Order Number'
  key PurchaseOrder : String(10) not null;
...
entity PurchaseOrder.A_PurchaseOrderScheduleLine {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
  @sap.quickinfo : 'Purchasing Document Number'
  ...
  to_SubcontractingComponent : Composition of many PurchaseOrder.A_POSubcontractingComponent {  };
};
...
entity PurchaseOrder.A_PurOrdAccountAssignment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
  @sap.quickinfo : 'Purchasing Document Number'
  key PurchaseOrder : String(10) not null;
...
entity PurchaseOrder.A_PurOrdPricingElement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
  @sap.quickinfo : 'Purchasing Document Number'
  key PurchaseOrder : String(10) not null;
...
@cds.external : true
type PurchaseOrder.DummyFunctionImportResult {
  @sap.label : 'TRUE'
  IsInvalid : Boolean;
};

@cds.external : true
type PurchaseOrder.GetPDFResult {
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
  PurchaseOrderBinary : LargeString not null;
};
